...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-background overflow-hidden font-sans relative">
      ...
      <div className="w-full max-w-[1200px] mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-center justify-between z-10 gap-16">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left mt-12 lg:mt-0">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-[1.1] mb-6 tracking-tight">
            Welcome back to your <br className="hidden lg:block"/>
            <span className="text-primary">workspace.</span>
          </h1>
          
          <p className="text-white/50 text-lg leading-relaxed max-w-md font-light mb-12">
            Global feedback made simple. Sign in to track complaints, manage polls, and influence organizational change.
          </p>
        ...
        <div className="w-full lg:w-[450px] flex-shrink-0 mb-12 lg:mb-0">
          <div className="glass-card rounded-[32px] p-8 sm:p-10 relative overflow-hidden backdrop-blur-xl bg-black/40 border border-white/10 shadow-2xl">
            ...
            <div className="mb-8">
              ...
              <p className="text-white/50 text-sm">Don&apos;t have an account? <Link href="/register" className="text-primary hover:text-primary/80 font-medium transition-colors">Create one</Link></p>
            </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  <input
                    ...
                    required
                    className="w-full h-12 sm:h-14 px-5 bg-white/5 border border-white/10 rounded-xl text-white placeholder:text-white/30 focus:outline-none focus:border-primary/50 focus:bg-white/10 transition-all text-sm font-medium"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  <input
                    ...
                    required
                    className="w-full h-12 sm:h-14 pl-5 pr-12 bg-white/5 border border-white/10 rounded-xl text-white placeholder:text-white/30 focus:outline-none focus:border-primary/50 focus:bg-white/10 transition-all text-sm font-medium tracking-wide"
                  />
                  <button 
                    type="button" 
